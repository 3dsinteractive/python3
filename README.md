...
- If you use the Go package `github.com/DataDog/go-python3` in your code, you can use `github.com/3dsinteractive/python3` as a drop-in replacement. We intend to not introduce breaking changes.
...
Then simply `go get github.com/3dsinteractive/python3`
